package com.wallet.wallet.filters;
...
import com.wallet.wallet.service.JwtTokenService;
        ...
        if (checkIfEndpointIsNotPublic(request)) {
            ...
            if (token != null) {
                ...
                Authentication authentication =
                        new UsernamePasswordAuthenticationToken(userDetails.getUser(), null, userDetails.getAuthorities());
